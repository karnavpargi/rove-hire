 ...
 *
 * Displays a paginated, searchable, filterable list of all candidates
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          View and manage all candidates in the pipeline.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="rounded-md border">
            <table className="w-full" role="grid" aria-label="Candidates list">
              <thead>
